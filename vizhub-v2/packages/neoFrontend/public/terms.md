...
<!-- TODO create this [VizHub's Standard Terms of Service](https://help.vizhub.com/articles/vizhub-terms-of-service) govern Users' use of the Service, except with respect to Users' activities under this Section B. -->
...
If Customer is a U.S. government entity or otherwise accessing or using the Service in a government capacity, the [U.S. Federal Government Amendment](https://help.vizhub.com/articles/amendment-to-vizhub-terms-of-service-applicable-to-us-federal-government-users) applies, and Customer agrees to its provisions.

#### 6. Enterprise Cloud Terms
If Customer signed up for VizHub Enterprise Cloud, the [Enterprise Cloud Addendum](https://help.vizhub.com/articles/vizhub-enterprise-cloud-addendum) applies, and Customer agrees to its provisions.
 -->
...
<!-- TODO add this Customer’s use of the Service must comply with [VizHub's Acceptable Use Policies](https://help.vizhub.com/articles/vizhub-acceptable-use-policies) and [VizHub’s Community Guidelines](https://help.vizhub.com/articles/vizhub-community-guidelines). -->
...
<!-- TODO add this The [VizHub Privacy Statement](https://help.vizhub.com/articles/vizhub-privacy-statement) provides detailed notice of VizHub's privacy and data use practices. Any person, entity, or service collecting data from the Service must comply with the VizHub Privacy Statement, particularly in regards to the collection of Users' Personal Information (as defined in the VizHub Privacy Statement). -->
...
<!-- TODO support various licenses. Customer may grant further rights to Customer Content if Customer adopts a license. -->
...
<!--
#### 5. Contributions Under Viz License
Whenever Customer makes a contribution to a viz containing notice of a license, it licenses such contributions under the same terms and agrees that it has the right to license such contributions under those terms. If Customer has a separate agreement to license its contributions under different terms, such as a contributor license agreement, that agreement will supersede.
-->
...
<!-- , including those on VizHub's [logos page](https://vizhub.com/logos). -->
...
<!--
### G. VizHub Additional Product Terms
Some Service features may be subject to additional terms as set forth in the [VizHub Additional Product Terms](/vizhub/site-policy/vizhub-additional-product-terms). By accessing or using these features, Customer agrees to the VizHub Additional Product Terms.
-->
...
<!--  and [served on VizHub's legal agent](/articles/guidelines-for-legal-requests-of-user-data/#submitting-requests). -->
