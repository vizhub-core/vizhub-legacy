...
test('clicking public shows public viz', () => {
  ...
  expect(screen.queryByText('My little private visualization')).not.toBeInTheDocument()
  expect(screen.queryByText('My small undefined public visualization')).toBeInTheDocument()
})
